...
class ImageReviewController extends Controller
{
    ...
    protected function imageData($scope = null)
    {
        ...
        return  $images->searchAble(['title', 'category:name', 'user:username,firstname,lastname', 'collections:title', 'admin:name,username', 'reviewer:name,username'])->orderBy('id', 'desc')->with('category', 'user', 'admin', 'reviewer')->paginate(getPaginate());
    }
}

...
class UserController extends Controller
{
    ...
    public function earningLog()
    {
        ...
        $logs      = EarningLog::where('contributor_id', auth()->id())->with('image:title,id')->orderBy('id', 'desc')->paginate(getPaginate());
    ...
    public function downloadHistory()
    {
        ...
        $downloads = Download::where('user_id', auth()->id())->with('image:title,id,category_id', 'image.category:id,name', 'contributor')->orderBy('id', 'desc')->paginate(getPaginate());

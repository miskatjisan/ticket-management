...
class ReportController extends Controller
{
    ...
    public function downloadLog()
    {
        ...
        $logs = Download::orderBy('id', 'desc')->with('user', 'image', 'contributor')->paginate(getPaginate());
    ...
    public function contributorEarningLog()
    {
        ...
        $logs      = EarningLog::orderBy('id', 'desc')->with('contributor', 'image:title,id')->paginate(getPaginate());

...
class ManageUsersController extends Controller
{
    ...
    public function showNotificationAllForm()
    {
        ...
        $users = User::where('ev', Status::YES)->where('sv', Status::YES)->where('status', Status::USER_ACTIVE)->count();
    ...
    {
        $user = User::findOrFail($id);
        $user->is_featured = $user->is_featured ? Status::DISABLE : Status::ENABLE;
        $user->save();

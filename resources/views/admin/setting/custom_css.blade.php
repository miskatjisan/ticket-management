...
@endpush
@push('style-lib')
    <link rel="stylesheet" href="{{asset('assets/admin_reviewer/css/codemirror.min.css')}}">
    <link rel="stylesheet" href="{{asset('assets/admin_reviewer/css/monokai.min.css')}}">
@endpush
@push('script-lib')
    <script src="{{asset('assets/admin_reviewer/js/codemirror.min.js')}}"></script>
    <script src="{{asset('assets/admin_reviewer/js/css.min.js')}}"></script>
    <script src="{{asset('assets/admin_reviewer/js/sublime.min.js')}}"></script>
@endpush
@push('script')
<script>
    "use strict";

                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                                <div>
                                    ...
                                    <p class="mb-0">
                                        <small>@lang('If you enable referral system, users can refer anyone and get percentage amount in each plan purchased per configuration.')@if ($general->referral_system)
                                                <a href="{{ route('admin.setting.index') }}">@lang('Configure referral system')</a>
                                            @endif
                                        </small>
                                    </p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p class="mb-0">
                                        <small>@lang('If you enable image auto approval system, users uploaded image will approved automatically')
                                            @if (!$general->auto_approval)
                                                <a href="{{ route('admin.images.pending') }}">@lang('See Pending Images')</a>
                                            @endif
                                        </small>
                                    </p>
                                </div>
                                <div class="form-group">
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" name="auto_approval" @if ($general->auto_approval) checked @endif>
                                </div>
                            </li>

...
@section('panel')
    ...
    <div class="row gy-4 mt-2">
        ...
        <div class="col-xxl-3 col-sm-6">
            <div class="widget-two box--shadow2 b-radius--5 bg--white">
                <i class="las la-ban overlay-icon text--danger"></i>
        ...
        <div class="col-xxl-3 col-sm-6">
            <div class="widget-two box--shadow2 b-radius--5 bg--white">
                <i class="las la-percentage overlay-icon text--primary"></i>
    ...
    <div class="row gy-4 mt-2">
        <div class="col-xxl-3 col-sm-6">
            <div class="widget-two style--two box--shadow2 b-radius--5 bg--15">
                <i class="las la-images overlay-icon text--white"></i>
                <div class="widget-two__icon b-radius--5 bg--15">
                    <i class="las la-images"></i>
                </div>
                <div class="widget-two__content">
                    <h3 class="text-white">{{ shortNumber($resources['total']) }}</h3>
                    <p class="text-white">@lang('Total Images')</p>
                </div>
                <a href="{{ route('admin.images.all') }}" class="widget-two__btn">@lang('View All')</a>
            </div>
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <div class="widget-two style--two box--shadow2 b-radius--5 bg--1">
                <i class="las la-folder-plus overlay-icon text--white"></i>
                <div class="widget-two__icon b-radius--5 bg--1">
                    <i class="las la-folder-plus"></i>
                </div>
                <div class="widget-two__content">
                    <h3 class="text-white">{{ shortNumber($resources['total_collections']) }}</h3>
                    <p class="text-white">@lang('Total Collections')</p>
                </div>
                <a href="{{ route('admin.report.user.image.collections') }}" class="widget-two__btn">@lang('View All')</a>
            </div>
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <div class="widget-two style--two box--shadow2 b-radius--5 bg--dark">
                <i class="las la-cloud-download-alt overlay-icon text--white"></i>
                <div class="widget-two__icon b-radius--5 bg--dark">
                    <i class="las la-cloud-download-alt"></i>
                </div>
                <div class="widget-two__content">
                    <h3 class="text-white">{{ shortNumber($resources['total_downloads']) }}</h3>
                    <p class="text-white">@lang('Total Downloads')</p>
                </div>
                <a href="{{ route('admin.report.download.log') }}" class="widget-two__btn">@lang('View All')</a>
            </div>
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <div class="widget-two style--two box--shadow2 b-radius--5 bg--3">
                <i class="las la-money-bill-wave-alt overlay-icon text--white"></i>
                <div class="widget-two__icon b-radius--5 bg--primary">
                    <i class="las la-money-bill-wave-alt"></i>
                </div>
                <div class="widget-two__content">
                    <h3 class="text-white">{{ $general->cur_sym . showAmount($resources['total_contributor_earnings']) }}</h3>
                    <p class="text-white">@lang('Contributor\'s Earning')</p>
                </div>
                <a href="{{ route('admin.report.contributor.earnings') }}" class="widget-two__btn">@lang('View All')</a>
            </div>
        </div><!-- dashboard-w1 end -->
    </div><!-- row end-->
    ...
    <div class="row gy-4 mt-2">
        <div class="col-xxl-3 col-sm-6">
            <div class="widget-two style--two box--shadow2 b-radius--5 bg--warning">
                <i class="las la-spinner overlay-icon text--white"></i>
                <div class="widget-two__icon b-radius--5 bg--warning">
                    <i class="las la-spinner"></i>
                </div>
                <div class="widget-two__content">
                    <h3 class="text-white">{{ shortNumber($resources['pending']) }}</h3>
                    <p class="text-white">@lang('Pending Images')</p>
                </div>
                <a href="{{ route('admin.images.pending') }}" class="widget-two__btn">@lang('View All')</a>
            </div>
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <div class="widget-two style--two box--shadow2 b-radius--5 bg--success">
                <i class="las la-check overlay-icon text--white"></i>
                <div class="widget-two__icon b-radius--5 bg--success">
                    <i class="las la-check"></i>
                </div>
                <div class="widget-two__content">
                    <h3 class="text-white">{{ shortNumber($resources['approved']) }}</h3>
                    <p class="text-white">@lang('Approved Images')</p>
                </div>
                <a href="{{ route('admin.images.approved') }}" class="widget-two__btn">@lang('View All')</a>
            </div>
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <div class="widget-two style--two box--shadow2 b-radius--5 bg--red">
                <i class="las la-times overlay-icon text--white"></i>
                <div class="widget-two__icon b-radius--5 bg--red">
                    <i class="las la-times"></i>
                </div>
                <div class="widget-two__content">
                    <h3 class="text-white">{{ $resources['rejected'] }}</h3>
                    <p class="text-white">@lang('Rejected Images')</p>
                </div>
                <a href="{{ route('admin.images.rejected') }}" class="widget-two__btn">@lang('View All')</a>
            </div>
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <div class="widget-two style--two box--shadow2 b-radius--5 bg--danger">
                ...
                <div class="widget-two__content">
                    <h3 class="text-white">{{ shortNumber($resources['predefined_reasons']) }}</h3>
                    <p class="text-white">@lang('Predefined Reason')</p>
                </div>
                <a href="{{ route('admin.manage.reason.all') }}" class="widget-two__btn">@lang('View All')</a>
            </div>
        </div><!-- dashboard-w1 end -->
    </div><!-- row end-->

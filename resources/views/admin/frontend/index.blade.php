...
@push('style-lib')
    <link href="{{ asset('assets/admin_reviewer/css/fontawesome-iconpicker.min.css') }}" rel="stylesheet">
@endpush

@push('script-lib')
    <script src="{{ asset('assets/admin_reviewer/js/fontawesome-iconpicker.js') }}"></script>
@endpush

        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.color.all') }}">
                    <a href="{{ route('admin.color.all') }}" class="nav-link ">
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.manage.reason.all') }}">
                    <a href="{{ route('admin.manage.reason.all') }}" class="nav-link ">
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.plan.all') }}">
                    <a href="{{ route('admin.plan.all') }}" class="nav-link ">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{ menuActive('admin.images*', 3) }}">
                    ...
                    <div class="sidebar-submenu {{ menuActive('admin.images*', 2) }} ">
                        <ul>
                            <li class="sidebar-menu-item {{ menuActive('admin.images.pending') }} ">
                                <a href="{{ route('admin.images.pending') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.images.rejected') }} ">
                                <a href="{{ route('admin.images.rejected') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.images.approved') }} ">
                                <a href="{{ route('admin.images.approved') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.images.all') }} ">
                                <a href="{{ route('admin.images.all') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{ menuActive('admin.report*', 2) }} ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.report.download.log') }}">
                                <a href="{{ route('admin.report.download.log') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Download Log')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{ menuActive('admin.report.contributor.earnings') }}">
                                <a href="{{ route('admin.report.contributor.earnings') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Contributor\'s Earnings')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{ menuActive('admin.report.user.image.collections') }}">
                                <a href="{{ route('admin.report.user.image.collections') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('User\'s Image Collection')</span>
                                </a>
                            </li>

@php
    $title = $deposit->plan_id ? 'Payment' : 'Deposit';
@endphp
    ...
    <div class="row mb-none-30 justify-content-center">
        <div class="col-xl-4 col-md-6 mb-30">
            <div class="card b-radius--10 overflow-hidden box--shadow1">
                <div class="card-body">
                    <h5 class="mb-20 text-muted"> {{ $title . ' Via' }} {{ __(@$deposit->gateway->name) }}</h5>
                    <ul class="list-group">
        ...
        @if ($details || $deposit->status == Status::PAYMENT_PENDING)
            <div class="col-xl-8 col-md-6 mb-30">
                <div class="card b-radius--10 overflow-hidden box--shadow1">
                    <div class="card-body">
                        <h5 class="card-title mb-50 border-bottom pb-2">{{ $title . ' Information' }}</h5>
                        @if ($details != null)

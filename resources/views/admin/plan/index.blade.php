                            ...
                            <tbody>
                                @forelse($plans as $plan)
                                    <tr>
                                        ...
                                        <td>
                                            <span class="d-block"> {{ $plan->daily_limit == -1 ? 'unlimited' : $plan->daily_limit }} / @lang('day')</span>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-end flex-wrap gap-2">
                                                <button class="btn btn-outline--primary cuModalBtn btn-sm" data-modal_title="@lang('Update Plan')" data-resource="{{ $plan }}"><i class="las la-pen"></i>@lang('Edit')
                                                </button>
                                                @if ($plan->status == 1)
...
@push('breadcrumb-plugins')
    <button class="btn btn-outline--primary btn-sm cuModalBtn" data-modal_title="@lang('Add Plan')">

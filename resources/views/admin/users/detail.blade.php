    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="d-flex flex-wrap gap-3 mt-4">
                ...
                <div class="flex-fill">
                    @if ($user->is_featured)
                        <button class="btn btn--danger btn--gradi btn--shadow w-100 btn-lg confirmationBtn" data-question="@lang('Are you sure that, you want to remove this user from featured user?')" data-action="{{ route('admin.users.featured', $user->id) }}">
                            <i class="las la-times"></i>@lang('Make Unfeatured')
                        </button>
                    @else
                        <button class="btn btn--success btn--gradi btn--shadow w-100 btn-lg confirmationBtn" data-question="@lang('Are you sure that, you want to add this user as featured user?')" data-action="{{ route('admin.users.featured', $user->id) }}">
                    ...
                    <form action="{{ route('admin.users.update', [$user->id]) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-xl-3 col-md- col-12">
                                ...
                                <input type="checkbox" data-width="100%" data-height="50" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-on="@lang('Verified')" data-off="@lang('Unverified')" name="kv" @if ($user->kv) checked @endif>
                            </div>
                        </div>

                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-end gap-1 flex-wrap">
                                                ...
                                                @if ($image->is_featured)
                                                    <button data-action="{{ route('admin.images.feature.update', $image->id) }}" data-question="@lang('Are you sure to unfeature this image?')" class="btn btn-sm btn-outline--dark confirmationBtn">
                                                        <i class="la la-times"></i>@lang('Unfeature')
                                                    </button>
                                                @else
                                                    <button data-action="{{ route('admin.images.feature.update', $image->id) }}" data-question="@lang('Are you sure to featured this image?')" class="btn btn-sm btn-outline--success confirmationBtn">

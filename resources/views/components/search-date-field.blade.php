...
@push('script-lib')
    <script src="{{ asset('assets/admin_reviewer/js/vendor/datepicker.min.js') }}"></script>
    <script src="{{ asset('assets/admin_reviewer/js/vendor/datepicker.en.js') }}"></script>
@endpush

@push('style-lib')
    <link rel="stylesheet" href="{{asset('assets/admin_reviewer/css/vendor/datepicker.min.css')}}">
@endpush

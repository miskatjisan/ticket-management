@foreach ($collections as $collection)
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="collection">
            ...
            <p class="collection__subtitle">{{ shortNumber($collection->images->count()) }} @lang('Photos') - @lang('Created by') <a href="{{ route('member.images', $collection->user->username) }}">{{ __($collection->user->fullname) }}</a></p>
            @if (count($tags))

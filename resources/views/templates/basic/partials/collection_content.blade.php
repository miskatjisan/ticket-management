...
<div class="sl-collection">
    ...
    <div class="sl-collection__content">
        <h5 class="modal-title mb-3" id="collectionModalLabel">@lang('Add to collection')</h5>
            ...
            <div class="sl-collection-box" data-simplebar>
                <ul class="list sl-collection-list list-group-flush collections" style="--gap: 0;">
                    @foreach ($collections as $collection)
                        ...
                        @endphp
                        <li class="list-group-item d-flex justify-content-between flex-wrap @if ($collected) active remove-collection @else select-collection @endif" data-collection="{{ $collection->id }}">

<div class="modal custom--modal fade" id="collectionModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="collectionModalLabel" aria-hidden="true">
        ...
        <div class="modal-content @if (Auth::check()) border-0 @endif">
            @if (!Auth::check())
                <div class="modal-header">
                    <h5 class="modal-title" id="collectionModalLabel">@lang('Add to collection')</h5>

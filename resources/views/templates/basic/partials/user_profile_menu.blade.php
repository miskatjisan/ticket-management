...
<ul class="primary-menu__sub">
    ...
    <li>
        <a href="{{ route('user.image.add') }}" class="t-link primary-menu__sub-link d-flex gap-2">
            <span class="d-inline-block xl-text lh-1">
    ...
    <li>
        <a href="{{ route('member.followers.followings', $user->username) }}" class="t-link primary-menu__sub-link d-flex gap-2">
            <span class="d-inline-block xl-text lh-1">
                <i class="las la-users"></i>
            </span>
            <span class="d-block flex-grow-1">
                @lang('Followers & Followings')
            </span>
        </a>
    </li>
    <li>
        <a href="{{ route('member.collections', $user->username) }}" class="t-link primary-menu__sub-link d-flex gap-2">
            <span class="d-inline-block xl-text lh-1">

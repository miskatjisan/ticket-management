    ...
    <div class="filter-sidebar__body" data-simplebar>
        <ul class="list" style="--gap: 0.5rem">
            ...
            <li>
                ...
                <ul class="list list--row flex-wrap align-items-center">
                    <li>
                        <span class="filter-btn__is search-param" data-param="is_free" data-param_value="1" data-search_type="single"> @lang('Free') </span>
                    </li>
                    <li>
                        <span class="filter-btn__is search-param" data-param="is_free" data-param_value="0" data-search_type="single"> @lang('Premium') </span>
                    </li>
                </ul>
            </li>
            @if ($colors->count())
                <li>
                    ...
                    <ul class="list list--row flex-wrap align-items-center">
                        <li>
                            <span type="checkbox" id="color-1" class="color-clear clear-param" data-param="color"></span>
                        </li>
                        @foreach ($colors as $color)
                            <li>
                                <span id="color-{{ $color->id }}" class="color-selector search-param" style="background: #{{ $color->color_code }};border: 1px solid @if ($color->color_code != 'ffffff' && $color->color_code != 'fff') #{{ $color->color_code }}; @else #bac8d3 @endif" data-param="color" data-param_value="{{ $color->color_code }}" data-search_type="single">
                            </li>
                        @endforeach
                    </ul>
                </li>
            ...
            <li>
                ...
                <ul class="list list--row flex-wrap align-items-center pb-3">
                    <li>
                        <span class="filter-btn__is search-param" data-param="period" data-search_type="single" data-param_value="3"> @lang('Last 3 months') </span>
                    </li>
                    <li>
                        <span class="filter-btn__is search-param" data-param="period" data-search_type="single" data-param_value="6"> @lang('Last 6 months') </span>
                    </li>
                    <li>
                        <span class="filter-btn__is search-param" data-param="period" data-search_type="single" data-param_value="12"> @lang('Last year') </span>
                    </li>
                </ul>
            </li>
        </ul>

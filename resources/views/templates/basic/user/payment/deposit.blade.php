    ...
    <form action="{{ route('user.deposit.insert') }}" method="post">
        ...
        <div class="card custom--card">
            ...
            <div class="card-body">
                    ...
                    <div class="input-group input--group">
                        @if (@$plan)
                            @php
                                $price = $period . '_price';
                            @endphp
                            <input type="number" step="any" name="amount" class="form-control form--control" value="{{ getAmount($plan->$price) }}" readonly="true" required>
                        @else
                ...
                <button type="submit" class="btn btn--base w-100 btn--lg mt-3">@lang('Submit')</button>
            </div>
        </div>
    </form>
@endsection
